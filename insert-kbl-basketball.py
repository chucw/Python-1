...
url = "https://sports.news.naver.com/basketball/schedule/index.nhn?category=kbl&year=2018&month=11"
...
for i in range(len(t_div)):
    ...
    if t_div[i].find('span',{'class':'td_hour'}):
        ...
        if td_hour == '-':
            ...
            if game_date >= '20181128' and game_date < '20181130':
                ...
                + str(home_score) + ",'" + str(awayteam) + "', " + str(away_score) + ", 'KBL');"
                curs.execute(sql)
